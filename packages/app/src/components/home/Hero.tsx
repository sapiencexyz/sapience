...
export default function Hero() {
  ...
  return (
    <section className="relative isolate flex flex-col w-full overflow-hidden min-h-[calc(100dvh-var(--page-top-offset,0px))] xl:min-h-[calc(100dvh-var(--page-top-offset,0px)-32px)] pb-[var(--ticker-height,0px)]">
      <HeroBackgroundLines />
