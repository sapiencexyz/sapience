  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Collateral transfer reindex running in background${fromBlock ? ` from block ${fromBlock}` : ' from token creation'} on chain ${DEFAULT_CHAIN_ID}. Check API logs for progress.`,
      });
    } catch (error) {
