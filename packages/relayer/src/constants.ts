...
export const V2_PREDICTION_MARKET_ESCROW_ETHEREAL_TESTNET =
  predictionMarketEscrow[CHAIN_ID_ETHEREAL_TESTNET]?.address as
    | `0x${string}`
    | undefined;
export const V2_CHAIN_ID_ETHEREAL_TESTNET = CHAIN_ID_ETHEREAL_TESTNET;
