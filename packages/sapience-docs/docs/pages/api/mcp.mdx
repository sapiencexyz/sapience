...
Add to [Claude Desktop](https://claude.ai/download) with [mcp-remote](https://github.com/geelen/mcp-remote?tab=readme-ov-file#usage). Web app integration [coming soon](https://www.anthropic.com/news/integrations)? 
