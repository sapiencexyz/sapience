<div style={{ position: 'relative', width: '100%', paddingBottom: '75%' }}>
  <iframe 
    ...
    src="https://www.youtube.com/embed/6P7EPCnndUQ?rel=0&modestbranding=1&showinfo=0" 
...
We recommend using [Cursor](https://www.cursor.com/) and [adding the Sapience docs](/cursor) for this project. You can also skip the steps below by cloning this repo directly in Cursor: [https://github.com/foilxyz/sapience-bot](https://github.com/foilxyz/sapience-bot)
