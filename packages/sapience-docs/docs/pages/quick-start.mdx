...
We recommend using [Cursor](https://www.cursor.com/) and [adding the Sapience docs](/cursor) for this project. You can also skip the steps below by cloning this repo in Cursor: `https://github.com/foilxyz/sapience-bot`
