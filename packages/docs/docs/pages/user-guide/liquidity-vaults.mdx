...
The vault is a smart contract that holds collateral and can sign bids on your behalf. The manager decides _which_ auctions to bid on and at what odds, but cannot withdraw your funds—only you can do that by redeeming your shares.
