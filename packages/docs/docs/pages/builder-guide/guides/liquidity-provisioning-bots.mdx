...
This guide builds on the previous bot guides. Complete the [Forecasting Agent](/builder-guide/guides/forecasting-agent) and [Trading Agent](/builder-guide/guides/trading-agent) first to understand basic bot setup and market interaction patterns.
...
> **Note**: These examples use internal hooks from the Sapience monorepo (`packages/app/src/hooks/contract`). If building a standalone app, you'll need to implement equivalent hooks using viem's contract interaction methods or adapt the SDK patterns.
