...
The [OpenClaw framework](https://github.com/openclaw/openclaw) includes built-in auction trading capabilities. Enable trading by setting `AUTONOMOUS_MODE=trade` or `ENABLE_TRADING=true`.
