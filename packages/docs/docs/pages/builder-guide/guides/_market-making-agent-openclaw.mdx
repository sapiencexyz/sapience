...
<div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap', marginBottom: '1rem' }}>
  <a href="https://github.com/openclaw/openclaw">
    <img alt="OpenClaw on GitHub" src="https://img.shields.io/badge/OpenClaw-openclaw%2Fopenclaw-181717?logo=github" />
  </a>
</div>
...
const PREDICTION_MARKET_ADDRESS = predictionMarketEscrow[CHAIN_ID_ETHEREAL].address;
```
