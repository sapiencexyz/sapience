...
const RESOLVER = escrowContracts.pythConditionResolver[CHAIN_ID_ETHEREAL].address;
const PREDICTION_MARKET = escrowContracts.predictionMarketEscrow[CHAIN_ID_ETHEREAL].address;
