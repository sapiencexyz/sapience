...
library Pool {
    function getCurrentPositionTokenAmounts(Market.Data storage market, Position.Data storage position)
        internal
        view
        returns (
            uint256 amount0,
        ...
        )
    {
        ...
        (,,,,, lowerTick, upperTick, liquidity,,, tokensOwed0U128, tokensOwed1U128) = INonfungiblePositionManager(
