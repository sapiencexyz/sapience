...
# Deploys and configures the full bridge between Ethereal and Arbitrum mainnets
...
deploy_test_collateral() {
    ...
    run_script "src/scripts/mainnet/00_DeployCollateral.s.sol:DeployCollateral" "$PM_NETWORK_RPC_URL" "Deploying Test Collateral Token on PM Network"
...
deploy_pyth_resolver() {
    ...
    run_script "src/scripts/mainnet/DeployPythConditionResolver.s.sol:DeployPythConditionResolver" "$PM_NETWORK_RPC_URL" "Deploying PythConditionResolver on Ethereal"
...
deploy_ct_resolvers() {
    ...
    run_script "src/scripts/mainnet/DeployConditionalTokensConditionResolver.s.sol:DeployConditionalTokensConditionResolver" "$PM_NETWORK_RPC_URL" "Deploying ConditionalTokensConditionResolver on Ethereal"
    ...
    run_script_no_verify "src/scripts/mainnet/ConfigureCTResolver.s.sol:ConfigureCTResolver" "$PM_NETWORK_RPC_URL" "Configuring CT Resolver bridge on Ethereal"
...
configure_ct_dvn() {
    ...
    run_script_no_verify "src/scripts/mainnet/SetDVN_CTResolver.s.sol:SetDVN_CTResolver" "$PM_NETWORK_RPC_URL" "Configuring DVN for CT Resolver on Ethereal (receive config)"
...
test_ct_bridge() {
    ...
    log_success "Resolution requested — track delivery at https://layerzeroscan.com/"
...
deploy_ethereal_phase1() {
    ...
    # 01. Deploy Resolver
    run_script "src/scripts/mainnet/01_DeployResolver.s.sol:DeployResolver" "$PM_NETWORK_RPC_URL" "Deploying ManualConditionResolver on PM Network"
    ...
    run_script "src/scripts/mainnet/02_DeployFactory.s.sol:DeployFactory" "$PM_NETWORK_RPC_URL" "Deploying PredictionMarketTokenFactory on PM Network"
    ...
    run_script "src/scripts/mainnet/03_DeployPredictionMarket.s.sol:DeployPredictionMarket" "$PM_NETWORK_RPC_URL" "Deploying PredictionMarketV2 on PM Network"
    ...
    run_script_no_verify "src/scripts/mainnet/04_ConfigureFactory.s.sol:ConfigureFactory" "$PM_NETWORK_RPC_URL" "Configuring PM Network Factory (set escrow as deployer)"

    # 05. Deploy PM Network Bridge (requires FACTORY_ADDRESS)
    run_script "src/scripts/mainnet/05_DeployEtherealBridge.s.sol:DeployEtherealBridge" "$PM_NETWORK_RPC_URL" "Deploying PositionTokenBridge on PM Network"
    ...
    run_script "src/scripts/mainnet/20_DeployAccountFactory.s.sol:DeployAccountFactory" "$PM_NETWORK_RPC_URL" "Deploying ZeroDevKernelAccountFactory and configuring on Escrow"
...
deploy_arbitrum_phase2() {
    ...
    run_script "src/scripts/mainnet/06_DeployFactorySM.s.sol:DeployFactorySM" "$SM_NETWORK_RPC_URL" "Deploying PredictionMarketTokenFactory on SM Network"
    ...
    run_script "src/scripts/mainnet/07_DeployRemoteBridge.s.sol:DeployRemoteBridge" "$SM_NETWORK_RPC_URL" "Deploying PredictionMarketBridgeRemote on SM Network"
...
configure_bridges_phase3() {
    ...
    run_script_no_verify "src/scripts/mainnet/08_ConfigureEtherealBridge.s.sol:ConfigureEtherealBridge" "$PM_NETWORK_RPC_URL" "Configuring PM Network Bridge"

    # 10. Configure SM Network Bridge
    run_script_no_verify "src/scripts/mainnet/10_ConfigureRemoteBridge.s.sol:ConfigureRemoteBridge" "$SM_NETWORK_RPC_URL" "Configuring Arbitrum SM Network Bridge"
...
configure_dvn_phase3b() {
    ...
    run_script_no_verify "src/scripts/mainnet/09_SetDVN_EtherealBridge.s.sol:SetDVN_EtherealBridge" "$PM_NETWORK_RPC_URL" "Setting DVN for PM Network Bridge"

    # 11. Set DVN for SM Network Bridge
    run_script_no_verify "src/scripts/mainnet/11_SetDVN_RemoteBridge.s.sol:SetDVN_RemoteBridge" "$SM_NETWORK_RPC_URL" "Setting DVN for SM Network Bridge"
...
configure_sm_only() {
    ...
    run_script_no_verify "src/scripts/mainnet/10_ConfigureRemoteBridge.s.sol:ConfigureRemoteBridge" "$SM_NETWORK_RPC_URL" "Configuring SM Network Bridge"
    run_script_no_verify "src/scripts/mainnet/11_SetDVN_RemoteBridge.s.sol:SetDVN_RemoteBridge" "$SM_NETWORK_RPC_URL" "Setting DVN for SM Network Bridge"
...
check_status() {
    ...
    run_script_no_verify "src/scripts/mainnet/12_CheckStatus_PMNetwork.s.sol:CheckStatus_PMNetwork" "$PM_NETWORK_RPC_URL" "Checking PM Network status"

    echo ""
    log_info "SM Network Status:"
    run_script_no_verify "src/scripts/mainnet/13_CheckStatus_SMNetwork.s.sol:CheckStatus_SMNetwork" "$SM_NETWORK_RPC_URL" "Checking SM Network status"
}
...
test_mint() {
    ...
    run_script_no_verify "src/scripts/mainnet/14_MintPositionTokens.s.sol:MintPositionTokens" "$PM_NETWORK_RPC_URL" "Minting position tokens"
...
test_bridge_to_remote() {
    ...
    run_script_no_verify "src/scripts/mainnet/15_TestBridgeToRemote.s.sol:TestBridgeToRemote" "$PM_NETWORK_RPC_URL" "Bridging tokens to Arbitrum"
...
test_bridge_back() {
    ...
    run_script_no_verify "src/scripts/mainnet/17_TestBridgeBack.s.sol:TestBridgeBack" "$SM_NETWORK_RPC_URL" "Bridging tokens back to Ethereal"
...
usage() {
    ...
    echo "  CONDITION_ID=0x... $0 test-ct-bridge       # Request CT resolution via LZ"
    echo "  CONDITION_ID=0x... $0 check-ct-resolution  # Check CT resolution on Ethereal"
    echo ""
...
main() {
    echo "========================================"
    echo "  Bridge Mainnet Deployment Script"
    echo "========================================"
    echo ""
