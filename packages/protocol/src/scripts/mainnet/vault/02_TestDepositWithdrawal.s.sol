...
contract TestDepositWithdrawal is Script {
    ...
    function run() external {
        ...
        console.log("=== Test Deposit and Withdrawal (Mainnet) ===");
        ...
        require(
            predictorCollateralAfterWithdraw
                == predictorCollateralBefore - depositAmount + withdrawAmount,
            "Incorrect collateral returned"
        );
