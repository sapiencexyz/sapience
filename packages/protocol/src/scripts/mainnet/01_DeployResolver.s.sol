...
/// @title Deploy Manual Condition Resolver (Mainnet)
/// @notice Deploys a ManualConditionResolver on Ethereal mainnet
contract DeployResolver is Script {
    function run() external {
        address deployer = vm.envAddress("PM_NETWORK_DEPLOYER_ADDRESS");

        console.log("=== Deploy Manual Condition Resolver (Mainnet) ===");
