...
/// @title Deploy Test Collateral Token (Mainnet)
/// @notice Deploys a mock ERC20 token for testing purposes only
/// @dev WARNING: This is for testing only. Production should use real collateral tokens.
contract DeployCollateral is Script {
    function run() external {
        ...
        console.log("=== Deploy Test Collateral Token (Mainnet) ===");
        console.log("WARNING: This is for TESTING ONLY!");
        console.log("");
