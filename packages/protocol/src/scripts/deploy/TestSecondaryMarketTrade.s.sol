...
/// @title Test Secondary Market Trade
...
contract TestSecondaryMarketTrade is Script {
    address SECONDARY_MARKET_ESCROW;
    address COLLATERAL;
    ...
    function run() external {
        SECONDARY_MARKET_ESCROW =
            vm.envAddress("SECONDARY_MARKET_ESCROW_ADDRESS");
        COLLATERAL = vm.envAddress("COLLATERAL_TOKEN_ADDRESS");
    ...
    ) internal view returns (ISecondaryMarketEscrow.TradeRequest memory) {
