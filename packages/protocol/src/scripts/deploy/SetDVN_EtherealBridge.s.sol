...
/// @dev Supports 1 or 2 DVNs via env vars. Set PM_NETWORK_DVN_1 (required) and
///      PM_NETWORK_DVN_2 (optional). ULN_CONFIRMATIONS defaults to 1.
contract SetDVN_EtherealBridge is Script {
    ...
    function run() external {
        ...
        address dvn2 = vm.envOr("PM_NETWORK_DVN_2", address(0));
        ...
        if (executor != address(0)) console.log("Executor:", executor);
