...
configure_ct_dvn() {
    ...
    run_script_no_verify "src/scripts/v2/mainnet/SetDVN_CTResolver.s.sol:SetDVN_CTResolver" "$PM_NETWORK_RPC_URL" "Configuring DVN for CT Resolver on Ethereal (receive config)"
