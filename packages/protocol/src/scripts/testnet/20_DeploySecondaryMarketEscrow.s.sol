...
/// @title Deploy SecondaryMarketEscrow on PM Network (Testnet)
/// @notice Deploys the atomic OTC swap contract on Ethereal testnet
contract DeploySecondaryMarketEscrow is Script {
    function run() external {
        ...
        console.log("=== Deploy SecondaryMarketEscrow PM Network (Testnet) ===");
