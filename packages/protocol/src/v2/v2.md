...
- Unified function names: `bridge()`, `retry()`, `emergencyCancel()`
- Common storage: pending bridges, escrowed balances, processed bridges
- Common constants: MIN_RETRY_DELAY, EMERGENCY_CANCEL_DELAY
...
5. Emergency escape (after 7 days without ACK):
   - Only original sender calls emergencyCancel(bridgeId)
...
- `CMD_CANCEL (3)`: Emergency cancel notification (7 days)
