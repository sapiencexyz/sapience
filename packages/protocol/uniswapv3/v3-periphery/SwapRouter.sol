    ...
    SelfPermit
{
    ...
    event logInt(string msg, int256 num);
    ...
    function uniswapV3SwapCallback(
        ...
        emit logInt("uniswapV3SwapCallback::amount0Delta", amount0Delta);
        emit logInt("uniswapV3SwapCallback::amount1Delta", amount1Delta);
