...
contract Quoter is IQuoter, IUniswapV3SwapCallback, PeripheryImmutableState {
    ...
    function uniswapV3SwapCallback(
        ...
        console.log(
            "Quoter::uniswapV3SwapCallback::amount0Delta",
            amount0Delta
        );
        console.log(
            "Quoter::uniswapV3SwapCallback::amount1Delta",
            amount1Delta
        );
        ...
        (address tokenIn, address tokenOut, uint24 fee) = path
            .decodeFirstPool();
        console.log("Quoter::uniswapV3SwapCallback::tokenIn", tokenIn);
        console.log("Quoter::uniswapV3SwapCallback::tokenOut", tokenOut);
        console.log("Quoter::uniswapV3SwapCallback::fee", fee);
        ...
        console.log(
            "Quoter::uniswapV3SwapCallback::isExactInput",
            isExactInput
        );
        console.log("Quoter::uniswapV3SwapCallback::amountToPay", amountToPay);
        console.log(
            "Quoter::uniswapV3SwapCallback::amountReceived",
            amountReceived
        );
        ...
        if (isExactInput) {
            ...
            if (amountOutCached != 0) {
                console.log(
                    "Quoter::uniswapV3SwapCallback::amountOutCached",
                    amountOutCached
                );
