...
>(({ className, children, hideCloseButton, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 z-50 grid w-full max-w-[90%] translate-x-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 rounded-sm',
        // Position near top on mobile for better usability, center on sm+
        'top-[5dvh] sm:top-1/2 sm:translate-y-[-50%]',
        // Constrain height and enable vertical scrolling
        'max-h-[85dvh] overflow-y-auto',
        // Preserve existing open/close animations
