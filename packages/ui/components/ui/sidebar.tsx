...
>(
  (
    ...
    const toggleSidebar = React.useCallback(() => {
      return isMobile
        ? setOpenMobile((openArg) => !openArg)
        : setOpen((openArg) => !openArg);
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] bg-background text-sidebar-foreground transition-[left,right,width] duration-200 ease-linear xl:flex',
            side === 'left'
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-background group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
