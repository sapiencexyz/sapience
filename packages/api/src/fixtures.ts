...
const buildIndexers = (): { [key: string]: IIndexer } => {
  ...
  if (ENABLE_V2_INDEXERS) {
    ...
    indexers['v2-transfer-ethereal'] = new V2PositionTokenTransferIndexer(5064014);
    indexers['v2-transfer-ethereal-testnet'] = new V2PositionTokenTransferIndexer(13374202);
