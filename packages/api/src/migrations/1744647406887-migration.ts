...
export class Migration1744647406887 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "market" ADD "baseTokenName" character varying`);
        await queryRunner.query(`ALTER TABLE "market" ADD "quoteTokenName" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "market" DROP COLUMN "quoteTokenName"`);
