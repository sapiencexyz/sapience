...
export class PopulateCollateralDecimals1712699000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log(
      `Found ${markets.length} markets to update with collateralDecimals`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.manager.update(Market, {}, { collateralDecimals: null });
  }
}
