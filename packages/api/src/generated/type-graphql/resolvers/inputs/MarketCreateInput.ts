...
import { Market_groupCreateNestedOneWithoutMarketInput } from "../inputs/Market_groupCreateNestedOneWithoutMarketInput";
import { PositionCreateNestedManyWithoutMarketInput } from "../inputs/PositionCreateNestedManyWithoutMarketInput";

@TypeGraphQL.InputType("MarketCreateInput", {})
export class MarketCreateInput {
  ...
  @TypeGraphQL.Field(_type => Market_groupCreateNestedOneWithoutMarketInput, {
    nullable: true
  })
  market_group?: Market_groupCreateNestedOneWithoutMarketInput | undefined;

  @TypeGraphQL.Field(_type => PositionCreateNestedManyWithoutMarketInput, {
    nullable: true
  })
  position?: PositionCreateNestedManyWithoutMarketInput | undefined;
}
