...
export function prepareMintCalls(
  ...
  const mintRequest = {
    ...
    predictorSignature: mintData.predictorSignature || '0x',
    ...
    counterpartySessionKeyData: (mintData.counterpartySessionKeyData
      ...
      : '0x') as Hex,
    predictorSponsor: mintData.predictorSponsor ?? zeroAddress,
    predictorSponsorData: mintData.predictorSponsorData ?? '0x',
  };
