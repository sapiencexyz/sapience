...
| 2   | Conditions + ConditionGroups + Questions — Relay-shaped entities + connections; deprecate `*Page` siblings             | A      | #1             | Not started                                                            |
| 3   | PickConfigurations + Trades + Positions — Relay-shaped entities + connections; `tradeByHash`                           | A      | #1, #2         | Not started                                                            |
